...
public class HorseEntity extends PathfinderMob implements GeoEntity {
	...
	public HorseEntity(EntityType<HorseEntity> type, Level world) {
		super(type, world);
		xpReward = 40;
		setNoAi(false);
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(AdamsCreaturesModEntities.HORSE.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(HorseEntity.RemovalReason.KILLED);
