...
public class BuffaloAttackDetectionProcedure {
					...
					Zpar = z + entity.getLookAngle().z * Range;
					{
						...
						for (Entity entityiterator : _entfound) {
							if (entityiterator == (entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null)) {
								if (((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null) != null ? entity.distanceTo((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null)) : -1) >= 6) {
									entity.getPersistentData().putString("State", "Charge");
								} else {
									entity.getPersistentData().putString("State", "MeleeAttack");
								}
