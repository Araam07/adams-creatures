...
public class BuffaloMeleeAttackProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (entity.getPersistentData().getDouble("IA") == 0) {
			...
			if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
				_entity.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 55, 1, false, false));
		}
		...
		if (entity.getPersistentData().getDouble("IA") < 47) {
		...
		if (entity.getPersistentData().getDouble("IA") > 47 && entity.getPersistentData().getDouble("IA") < 53) {
