...
public class AdamsCreaturesModMenus {
	...
	public static final DeferredHolder<MenuType<?>, MenuType<NameTamedCreatureMenu>> NAME_TAMED_CREATURE = REGISTRY.register("name_tamed_creature", () -> IMenuTypeExtension.create(NameTamedCreatureMenu::new));
}
