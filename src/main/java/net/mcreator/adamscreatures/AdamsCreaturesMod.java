package net.mcreator.adamscreatures;
...
@Mod("adams_creatures")
public class AdamsCreaturesMod {
	public static final Logger LOGGER = LogManager.getLogger(AdamsCreaturesMod.class);
	public static final String MODID = "adams_creatures";

	public AdamsCreaturesMod(IEventBus modEventBus) {
